# Jocall3 Node API Library

[![NPM version](https://img.shields.io/npm/v/jocall3-node.svg)](https://npmjs.org/package/jocall3-node) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/jocall3-node)
...
add the following import before your first import `from "Jocall3"`:
