...
- <code title="get /accounts/{accountId}/statements/{statementId}/pdf">client.accounts.statements.<a href="./src/resources/accounts/statements.ts">downloadPdf</a>(accountId, statementId) -> Response</code>
