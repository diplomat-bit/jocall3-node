...
export class Ads extends APIResource {
   ...
   * ```
   */
  list(query?: AdListParams, options?: Core.RequestOptions): Core.APIPromise<unknown>;
  list(options?: Core.RequestOptions): Core.APIPromise<unknown>;
  list(
    query: AdListParams | Core.RequestOptions = {},
   ...
   * ```
   */
  generate(body: AdGenerateParams, options?: Core.RequestOptions): Core.APIPromise<unknown> {
   ...
   * ```
   */
  getOperation(operationId: string, options?: Core.RequestOptions): Core.APIPromise<unknown> {
